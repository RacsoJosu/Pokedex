...
function CardPokemon({onOpen,name, pokemonId,image,isFavorite, types, onSelected}) {
  ...
  return (
    <div  className=" shadow-xl border-[2px]  rounded-xl  inline-block mx-10 my-5">
      <section>
      ...
      <section onClick={handleSelected} className="cursor-pointer">
        <figure className="w-full h-full">
          <img className=" h-full w-full mx-auto object-cover border-t-2 border-b-2 " src={`${image}`} alt="imagen" />
        </figure>
